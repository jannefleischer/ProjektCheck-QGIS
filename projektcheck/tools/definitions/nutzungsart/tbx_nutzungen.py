...
from tools.definitions.projektverwaltung.tbx_teilflaechen_verwalten import \
     TbxFlaechendefinition
from tools.definitions.nutzungsart.nutzungen import (
    NutzungenGewerbe, NutzungenWohnen, NutzungenEinzelhandel)
from tools.utils.encoding import encode
from tools.utils.constants import Branche, Gewerbegebietstyp
from tools.utils.spatial_lib import get_gemeindetyp
from tools.utils.basetable_definitions import (
