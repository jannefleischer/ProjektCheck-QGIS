...
from pctools.analyst.standortkonkurrenz.market_templates import MarketTemplate, DEFAULT_NAME
from pctools.analyst.standortkonkurrenz.tbx_osm_markteinlesen import MarktEinlesen
